...
<!-- MODAL BIENVENIDA ADMIN -->
<div id="modalBienvenida" class="modal-bienvenida">
  <div class="modal-content-bienvenida">

    <h2>👋 Bienvenido Administrador</h2>

    <p class="fecha" id="fechaActual"></p>
    <p class="hora" id="horaActual"></p>

    <div class="resumen">
      <p>📅 Citas Hoy: <strong><?php echo $citas_hoy; ?></strong></p>
      <p>⏳ Pendientes: <strong><?php echo $pendientes; ?></strong></p>
      <p>✅ Confirmadas: <strong><?php echo $confirmadas; ?></strong></p>
    </div>

    <div class="botones-modal">
      <a href="admin.php" class="btn-panel">Ir al Panel</a>
      <a href="admin.php?filtro=hoy" class="btn-hoy">Ver citas de hoy</a>
    </div>
